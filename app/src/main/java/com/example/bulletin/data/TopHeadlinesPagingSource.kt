...
class TopHeadlinesPagingSource(private val newsInterface: NewsInterface) : PagingSource<Int, Article>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        ...
        return try {
            val data = newsInterface.getTopHeadlines(country = "in", apiKey = Constants.API_KEY,
